...
<template>
  <div class="hots">
    <carousel
      v-model:current="pcurrent" switch :loop="true" :list="props.list" :height="carouselHeight"
      direction="vertical" :offset-x-step="48" :offset-y-step="48" :scale-step="0.8" :opacity-step="0.9"
      :rotate-step="15" overflow="visible"
    >
