...
const saveAddress = () => {
  uni.setStorageSync('defaultAddress', { username: userName.value, mobile: mobile.value, address: addressStr.value, addressInfo: addressInfo.value, isDefault: isDefault.value })
  hiddenMask(false)
}
</script>
