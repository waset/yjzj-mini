  ...
  <div class="relocation">
    ...
    >
      <div class="select">
        ...
        <div class="header">
          <common-search
            :value="getModificationListParams.productName" is-input @update:value="(val) => {
        ...
        <product-custom-filter-list ref="ProductCustomFilterListRef" v-model:value="getModificationListParams" @update:value="getAllocationListByParams()" />
